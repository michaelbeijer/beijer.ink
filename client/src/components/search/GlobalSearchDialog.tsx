...
export function GlobalSearchDialog({ isOpen, onClose, onSelectNote }: GlobalSearchDialogProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-start justify-center pt-[15vh]">
      ...
      {/* Dialog */}
      <div className="relative w-full max-w-xl bg-slate-900 border border-slate-700 rounded-xl shadow-2xl">
        {/* Search input */}
        <div className="flex items-center gap-3 px-4 py-3 border-b border-slate-700">
          ...
          <kbd className="hidden sm:inline-block text-xs text-slate-500 bg-slate-800 px-1.5 py-0.5 rounded border border-slate-700">
            ESC
          </kbd>
        </div>
            ...
            <>
              {results.map((result) => (
                <button
                  ...
                  className="w-full text-left px-4 py-3 hover:bg-slate-800 transition-colors border-b border-slate-800/50"
                >
                  <div className="flex items-start gap-2">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <p
                        className="text-xs text-slate-400 mt-1 line-clamp-2 [&_mark]:bg-yellow-500/30 [&_mark]:text-yellow-200 [&_mark]:rounded-sm [&_mark]:px-0.5"
