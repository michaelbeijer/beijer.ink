  ...
  return (
    <div className="relative flex items-center gap-1 flex-wrap" ref={dropdownRef}>
      ...
      <button
        ...
        className="inline-flex items-center gap-0.5 px-1.5 py-0.5 text-xs text-slate-500 hover:text-slate-700 dark:hover:text-slate-300 hover:bg-slate-200 dark:hover:bg-slate-800 rounded transition-colors"
      >
      ...
      {isOpen && (
        <div className="absolute top-full left-0 mt-1 z-50 w-56 bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-lg shadow-xl py-1">
          <div className="px-2 py-1.5">
            <input
              ...
              className="w-full bg-slate-100 dark:bg-slate-900 text-slate-900 dark:text-white text-sm px-2 py-1 rounded border border-slate-300 dark:border-slate-700 focus:outline-none focus:ring-1 focus:ring-blue-500"
              autoFocus
            />
          </div>
          ...
          <div className="max-h-40 overflow-y-auto">
            ...
            {canCreate && (
              <button
                ...
                className="flex items-center gap-2 w-full px-3 py-1.5 text-sm text-blue-600 dark:text-blue-400 hover:bg-slate-100 dark:hover:bg-slate-700"
              >
